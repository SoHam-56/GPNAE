...
VL_ATTR_COLD void VTB_gpnae___024root___eval_stl(VTB_gpnae___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        VTB_gpnae_multiply_32___stl_sequent__TOP__TB_gpnae__DOT__dut__DOT__selu_inst__DOT__multiply_32_inst__0((&vlSymsp->TOP__TB_gpnae__DOT__dut__DOT__mac_inst__DOT__datapath_inst__DOT__MUL));
    }
}
...
VL_ATTR_COLD void VTB_gpnae___024root___stl_sequent__TOP__0(VTB_gpnae___024root* vlSelf) {
    ...
    if (vlSelfRef.TB_gpnae__DOT__dut__DOT__is_positive_selu) {
        vlSelfRef.TB_gpnae__DOT__dut__DOT__selu_const = 0x3f867d5fU;
        ...
        vlSelfRef.TB_gpnae__DOT__dut__DOT__selu_const = 0x3fd62d7dU;
        vlSelfRef.TB_gpnae__DOT__dut__DOT__selu_input 
    ...
    if ((4U & (IData)(vlSelfRef.TB_gpnae__DOT__dut__DOT__current_state))) {
        ...
        if ((1U & (IData)(vlSelfRef.TB_gpnae__DOT__dut__DOT__current_state))) {
            if (vlSelfRef.TB_gpnae__DOT__dut__DOT__is_positive_selu) {
                vlSelfRef.TB_gpnae__DOT__dut__DOT__next_state = 4U;
                vlSelfRef.TB_gpnae__DOT__dut__DOT__selu_valid = 1U;
            } else {
                vlSelfRef.TB_gpnae__DOT__dut__DOT__next_state = 5U;
            }
        } else {
            vlSelfRef.TB_gpnae__DOT__dut__DOT__next_state 
